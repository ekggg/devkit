...
function renderValue(kind: FileKind, value: string) {
  switch (kind) {
    case 'audio':
      return (
        <div className="p-2">
    ...
    case 'video':
      return (
        <div className="p-2">
          <video src={value} controls controlsList="nodownload nofullscreen noremoteplayback" className="block w-full" />
          <div className="pt-2 text-center text-xs text-gray-500 dark:text-gray-400">Click to select another video file</div>
        </div>
      )
  }
}
